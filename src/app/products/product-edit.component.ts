...
export class ProductEditComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  get times(): FormArray {
    return this.productForm.get('times') as FormArray;
  }
  ...
  constructor(
    ...
    this.validationMessages = {
      ...
      productCode: {
        required: 'Movie code is required.',
      },
      productLocation: {
        required: 'Movie location is required.',
      },
      starRating: {
  ...
  displayProduct(product: Product): void {
    ...
    if (this.product.id === 0) {
      ...
      this.pageTitle = `Edit Movie: ${this.product.productName}`;
    }
    ...
    this.productForm.setControl(
      'times',
      this.fb.array(this.product.times || [])
    );
    // console.log(this.product.tags);
    // console.log(this.product.times);
  }
